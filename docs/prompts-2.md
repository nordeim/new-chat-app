...
Please carefully read completely and internalized your operating instructions in the attached/pasted text.
Now, please `git clone https://github.com/nordeim/new-chat-app.git` to your local workspace, then meticulously meticulously plan to create  `AGENTS.md` , `CLAUDE.md` , `README.md` for the codebase using the repo included skills `skills/agents-md/SKILL.md` , `skills/claude-md/SKILL.md` and `skills/readme-md/SKILL.md` respectively.
