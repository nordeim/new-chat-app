...
| 🖼️ | Image-aware composer | PNG/JPEG/WebP attachments under 2 MB, validated client-side and re-verified by magic bytes server-side, with a full-size lightbox |
| 📝 | Readable answers | GitHub-flavored Markdown, syntax-highlighted code with copy, and a composer character count |
...
├── 📂 components
│   ├── 📄 chat-workspace.tsx       # Client workspace shell, composer, history, dialogs
│   ├── 📄 markdown-message.tsx     # GFM + syntax highlighting + copy-code
│   └── 📄 image-lightbox.tsx       # Full-size attachment preview
├── 📂 db
